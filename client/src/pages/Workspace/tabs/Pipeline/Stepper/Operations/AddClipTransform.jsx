...
const AddClipTransform = ({ setLoading }) => {
    ...
    const handleAddClip = async () => {
        const clipData = {
            ...
            clipping_geojson: clipFeatures
        };
		setTransformationsData(prevData => [...prevData, clipData]);
    };
...
export default AddClipTransform;