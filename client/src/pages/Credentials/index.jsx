        ...
        <Box sx={{ mt: 2, overflow: 'auto', height: '100vh', maxWidth: pageMaxWidth }}> 
            ...
            >
                ...
                >
                    ...
                    >
                        Create and manage your API keys and OAuth credentials
                    </Typography>
                </Box>
                <Box
                    sx={{
            ...
            >
                ...
                >
                    <Tab label="API Keys" sx={{ textTransform: 'none', color: theme.palette.text.primary  }} />
                    <Tab label="OAuth 2.0" sx={{ textTransform: 'none', color: theme.palette.text.primary  }} />
                </Tabs>
                <Divider />
                <Box
                    sx={{
                ...
                >
                    <Box sx={{ flex: 1, pr: 3 }}>
                        ...
                        >
                            {tabIndex === 0 && "Create and manage your API keys"}
                            {tabIndex === 1 && "Create and manage OAuth credentials"}
                        </Typography>
                    </Box>
                    <Box sx={{ flex: 3 }}>
                        {tabIndex === 0 && <Apikey />}
